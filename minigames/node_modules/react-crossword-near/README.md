...
```sh
npm install --save react-crossword-near
# or
yarn add react-crossword-near
```

## Usage

> See also the [styleguidist docs for from the original Crossword](https://jaredreisinger.github.io/react-crossword).
